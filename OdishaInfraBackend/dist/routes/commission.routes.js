...
router.get('/developers', auth_middleware_1.authenticate, (0, auth_middleware_1.requireRole)('ADMIN'), async (_req, res) => {
    try {
...
router.put('/developers/:developerId', auth_middleware_1.authenticate, (0, auth_middleware_1.requireRole)('ADMIN'), async (req, res) => {
    try {
        ...
        const developer = await prisma_1.default.developerProfile.update({
...
// ─── ADMIN: Record a sale ───────────────────────────────────────────────────
router.post('/sales', auth_middleware_1.authenticate, (0, auth_middleware_1.requireRole)('ADMIN'), async (req, res) => {
    try {
        ...
        const developer = await prisma_1.default.developerProfile.findUnique({
            where: { id: developerId },
        });
        if (!developer)
...
router.get('/sales', auth_middleware_1.authenticate, (0, auth_middleware_1.requireRole)('ADMIN'), async (req, res) => {
    try {
...
router.put('/sales/:saleId/paid', auth_middleware_1.authenticate, (0, auth_middleware_1.requireRole)('ADMIN'), async (req, res) => {
    try {
